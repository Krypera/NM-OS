...
REQUIRED=(
    ...
    "${ROOT_DIR}/config/system-overlay/etc/dbus-1/system.d/org.nmos.Update1.conf"
    "${ROOT_DIR}/config/system-overlay/etc/default/grub.d/90-nmos-ab.cfg"
    "${ROOT_DIR}/config/system-overlay/etc/grub.d/09_nmos_ab"
    ...
    "${ROOT_DIR}/config/system-overlay/usr/lib/systemd/system/nmos-update-engine.service"
    "${ROOT_DIR}/config/system-overlay/usr/lib/systemd/system/nmos-update-health.service"
    ...
    "${ROOT_DIR}/config/system-overlay/usr/local/bin/nmos-help"
    "${ROOT_DIR}/config/system-overlay/usr/local/bin/nmos-settings-service"
    "${ROOT_DIR}/config/system-overlay/usr/local/bin/nmos-update-engine-service"
    "${ROOT_DIR}/config/system-overlay/usr/local/lib/nmos/settings_bootstrap.py"
    "${ROOT_DIR}/config/system-overlay/usr/local/lib/nmos/update_boot_health.py"
    ...
    "${ROOT_DIR}/config/system-overlay/usr/share/applications/nmos-help.desktop"
    ...
    "${ROOT_DIR}/config/system-overlay/usr/share/nmos/update-signing.gpg"
    ...
    "${ROOT_DIR}/config/installer/experimental-ab/profile.json"
    "${ROOT_DIR}/config/installer/experimental-ab/prepare-target.sh"
    "${ROOT_DIR}/config/recovery/README.md"
    "${ROOT_DIR}/config/recovery/collect-diagnostics.py"
    "${ROOT_DIR}/config/recovery/rollback-helper.sh"
    "${ROOT_DIR}/config/recovery/verify-manifest.py"
    "${ROOT_DIR}/config/installer-packages/base.txt"
    "${ROOT_DIR}/config/update-catalog.json"
    "${ROOT_DIR}/config/system-packages/base.txt"
    "${ROOT_DIR}/config/system-packages/productivity.txt"
    ...
    "${ROOT_DIR}/apps/nmos_control_center/nmos_control_center/panels/applications.py"
    "${ROOT_DIR}/apps/nmos_control_center/nmos_control_center/panels/language.py"
    "${ROOT_DIR}/apps/nmos_control_center/nmos_control_center/panels/network.py"
    "${ROOT_DIR}/apps/nmos_control_center/nmos_control_center/panels/personalization.py"
    "${ROOT_DIR}/apps/nmos_control_center/nmos_control_center/panels/security.py"
    "${ROOT_DIR}/apps/nmos_control_center/nmos_control_center/panels/system.py"
    "${ROOT_DIR}/apps/nmos_greeter/nmos_greeter/main.py"
    "${ROOT_DIR}/apps/nmos_greeter/nmos_greeter/browser_model.py"
    ...
    "${ROOT_DIR}/apps/nmos_help/nmos_help/main.py"
    ...
    "${ROOT_DIR}/apps/nmos_update/nmos_update/service.py"
    "${ROOT_DIR}/docs/build.md"
    "${ROOT_DIR}/docs/runtime.md"
    "${ROOT_DIR}/docs/security-model.md"
    "${ROOT_DIR}/docs/security-profiles.md"
    "${ROOT_DIR}/docs/translations.md"
    "${ROOT_DIR}/docs/vision.md"
    "${ROOT_DIR}/docs/windows-wsl.md"
    "${ROOT_DIR}/docs/user-experience.md"
    "${ROOT_DIR}/docs/user-guides/getting-started.md"
    "${ROOT_DIR}/docs/user-guides/internet-and-email.md"
    "${ROOT_DIR}/docs/user-guides/software-installation.md"
    "${ROOT_DIR}/docs/user-guides/files-and-folders.md"
    "${ROOT_DIR}/docs/user-guides/printing.md"
    ...
    "${ROOT_DIR}/tests/e2e/run-qemu-ab-smoke.sh"
    ...
    "${ROOT_DIR}/tests/smoke/verify-security-matrix-gates.sh"
    "${ROOT_DIR}/tests/smoke/verify-security-setting-explanations.sh"
    "${ROOT_DIR}/tests/smoke/verify-comfort-mode.sh"
    "${ROOT_DIR}/tests/smoke/verify-help-discoverability.sh"
    "${ROOT_DIR}/tests/smoke/verify-emergency-lockdown.sh"
    "${ROOT_DIR}/tests/smoke/verify-trust-chain-privacy-dashboard.sh"
    "${ROOT_DIR}/tests/smoke/verify-app-sandbox-presets.sh"
    ...
    "${ROOT_DIR}/tests/smoke/verify-update-engine.sh"
